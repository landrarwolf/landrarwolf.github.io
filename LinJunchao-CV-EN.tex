...
\WorkEntry{Software Engineer}{2019-2021}{Some Tech Company}{
    \begin{itemize}
        \item Developed and maintained internal systems
        \item Participated in project requirement analysis and design
        \item Optimized system performance and enhanced user experience
    \end{itemize}
}
...
\WorkEntry{Some Project}{2020-2021}{Project Lead}{
    \begin{itemize}
        \item Led frontend development
        \item Designed backend APIs
        \item Implemented core business features
    \end{itemize}
}
