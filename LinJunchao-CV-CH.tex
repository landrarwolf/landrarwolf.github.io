...
\PersonalEntry{邮箱}{\href{mailto:linjunchao@hust.com}{linjunchao@hust.com}}
\PersonalEntry{电话}{+86 130-7128-8955}
\PersonalEntry{地址}{湖北省武汉市洪山区华中科技大学}
\PersonalEntry{个人网站}{\href{https://github.com/landrarwolf}{GitHub: landrarwolf}}

\NewPart{教育背景}{}
\sepspace

\EducationEntry{本科}{2015-2019}{某某大学}{计算机科学与技术}{
    \begin{itemize}
        \item 主修课程：数据结构、算法设计、操作系统、数据库系统等
        \item 平均成绩：85/100
        \item 专业排名：前20\%
    \end{itemize}
}
...
\SkillsEntry{编程语言}{Java, Python, JavaScript}
\SkillsEntry{开发框架}{Spring, Django, React}
\SkillsEntry{数据库}{MySQL, MongoDB}
\SkillsEntry{语言能力}{中文（母语），英语（熟练）}

\NewPart{项目经验}{}
\sepspace

\WorkEntry{某某项目}{2020-2021}{项目负责人}{
    \begin{itemize}
        \item 负责前端开发工作
        \item 参与后端接口设计
        \item 实现核心业务功能
